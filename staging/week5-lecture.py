...
sents = gutenberg.sents('blake-poems.txt')  # is this a lexicon or text?
words = gutenberg.words('blake-poems.txt')  # is this?
text = nltk.Text(words)                     # is this?
freq = nltk.FreqDist(words)                 # is this?
vocab = set(words)                          # or even this?
